...
struct DefaultColorPalette: ColorPaletteProtocol {
    ...
    var defaultText: UIColor = DefaultColorPalette.getColor("defaultText")
    var supportText: UIColor = DefaultColorPalette.getColor("supportText")
    var disabledText: UIColor = DefaultColorPalette.getColor("disabledText")
    var defaultTextInverse: UIColor = DefaultColorPalette.getColor("defaultTextInverse")
    var supportTextInverse: UIColor = DefaultColorPalette.getColor("supportTextInverse")
